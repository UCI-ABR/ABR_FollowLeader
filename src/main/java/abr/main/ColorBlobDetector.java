/* Class modified from OpenCV Example */
package abr.main;
...
public class ColorBlobDetector {
    ...
    //private Scalar mColorRadius = new Scalar(5,50,125,0);
    ...
    public void process(Mat rgbaImage) {
        ...
        //reset moment back to null
        if(contours.size()==0){
        	momentX = 3.14159; //a specific value for easy debugging
        	momentY = 3.14159; //a specific value for easy debugging
        }
